...
<head>
  ...
  <title>Admin Portfolio | Dashboard</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item menu-open">
         ...
         <li class="nav-item menu-open">
            <a href="index.php?contactform=true" class="nav-link active">
            <i class="fa fa-phone" aria-hidden="true"></i>
              <p>
                Contact Form   
              </p>
...
<!-- card-header -->
<!-- form Start -->
<img src="../images/<?=$user_data['profile_pic']?>" class="col-1">
...
<h3 class="card-title">Update Contact Details</h3>
    ...
    <input type="text" class="form-control" name="email" value= "<?=$user_data['email_user']?>" id="exampleInputPassword1" placeholder="Enter Email">
    </div>
...
<!-- Contact Form Admin -->
        <?php
          ...
          ?>
<div class="card card-primary col-lg-10" bis_skin_checked="1">
<div class="card-header" bis_skin_checked="1">
<h3 class="card-title">Manage Contact Email</h3>
</div>
    <!-- card-header -->
    <!-- form Start -->
    <div class="card" bis_skin_checked="1">
...
<tr>
    ...
    <td><?= $pi['message'] ?></td>
    <td>
    <a href="../include/deleteform.php?id=<?=$pi['id']?>">Delete</a>
</tr>
<?php
    $c++;
}
...
<table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><img src="../images/<?=$user_data['admin_profile']?>" width="80px"></td>
...
<h3 class="card-title">Update Account Setting</h3>
    ...
    <img src="../images/<?=$user_data['admin_profile']?>" class="col-4">
    <form role="form" action="../include/admin.php" method="POST" enctype="multipart/form-data">
    <div class="card-body" bis_skin_checked="1">
    <div class="form-group" bis_skin_checked="1">
